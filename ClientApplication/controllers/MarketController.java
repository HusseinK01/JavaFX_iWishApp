...
public class MarketController implements Initializable {
    ...
    label.setStyle("-fx-font-weight: bold; -fx-text-fill: #35415A;");
    ...
    starIcon.setFill(Color.web("#35415A"));
    ...
    okButton.setStyle("-fx-background-color: transparent; -fx-text-fill: #35415A; -fx-font-weight: bold;");
