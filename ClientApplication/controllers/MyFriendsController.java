...
//    }
  ...
  private void showContributeDialog(String contributor, String wishingUser, int index) {
        ...
        confirmButton.setStyle("-fx-background-color:  #f7bc50; -fx-text-fill: #35415A; -fx-font-weight: bold;");
        confirmButton.setOnAction(event -> {
            // Get the selected item and its details
            ItemDTO selectedItem = wishlistTable.getItems().get(index);
            int price = selectedItem.getPrice();
           ...
           if(Client.balance<enteredAmount){ 
                ...
                contentLabel.setStyle("-fx-text-fill: #35415A; -fx-font-weight: bold; ");
                ...
                dialogPane.setStyle("-fx-background-color: #f7bc50;");
        ...
        cancelButton.setStyle("-fx-background-color: #f7bc50; -fx-text-fill: #35415A; -fx-font-weight: bold;");
        ...
        gridPane.setStyle("-fx-background-color: #35415A;");

        amountLabel.setStyle("-fx-text-fill: #f7bc50; -fx-font-weight: bold;");
        amountField.setStyle("-fx-text-fill: #35415A; -fx-font-weight: bold; -fx-background-color: #f7bc50;");

        gridPane.addRow(0, amountLabel, amountField);
        gridPane.addRow(1, confirmButton, cancelButton);

        Scene contributeScene = new Scene(gridPane, 400, 250, Color.TRANSPARENT);
        contributeStage.setScene(contributeScene);
        contributeStage.showAndWait();
    }  
